...
\begin{itemize}
  ...
  \item Maximum number of transactions per block is roughly 2600. 
...
Since its launch in 2009, Bitcoin served more than 380 million of transactions and has 33 million registered users as of February 2019 \cite{blockchain}
...
The forking process is illustrated on Figure \ref{fig:fig8}.
...
Figure \ref{fig:fig9} depicts most prominent Bitcoin hard forks. 
